    ...
    <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Cadastro de Lembretes</h4>
                <div class="row">
                  <form class="col s12" method="POST" action="processal.php">
                    <div class="row">
                      <div class="input-field col s12">
                        <input id="first_name" type="text" name="titulo" cha>
                        <label for="first_name">Título do Lembrete</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s4">
                        <input id="last_name" type="text" name="local">
                      ...
                      <div class="input-field col s4">
                          <input placeholder="01/01/2017" id="date-demo1" type="text" name="data">
                          <label for="date_demo1">Data</label>
                        </div>
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        <textarea id="message5" class="materialize-textarea" length="120" name="detalhes"></textarea>
                        <label for="message">Detalhes do Lembrete</label>
                      </div>
                      </div>
                      <div class="row">
