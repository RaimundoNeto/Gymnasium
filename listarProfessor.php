<?php
  ...
  $consulta = "SELECT nome, telefone, dataIngre FROM tb_cadProfessor";
  $cns = $liga->query($consulta) or die($liga->error);
?>
...
<div class="divider"></div>
            <div id="responsive-table">
              <h4 class="header">Lista de Professores</h4>
              <div class="row">
                <div class="col s12">
                <div class="card" >
                  ...
                  <thead>
                    <tr>
                        ...
                        <th>Nome</th>
                        <th>Telefone</th>
                        <th>Data do Ingresso</th>
                       
                    </tr>
                    
                  </thead>
                    <tbody>
                    <tbody><?php while ($dado = $cns->fetch_array()) {?>

                    
                      <tr>
                        <td>
                       <p>
                        <a class="btn-floating waves-effect waves-light cyan-dark-2"><i class="mdi-editor-border-color"></i>Editar</a>
          ...
          <!-- Floating Action Button -->
            <div class="fixed-action-btn" style="bottom: 50px; right: 19px;">
                ...
                <ul>
                  ...
                  <!--/////////////////////Botão Sair///////////////////////////// -->
                  <li><a title="Sair" href="app-calendar.html" class="btn-floating red">
